...
<head>
	...
	<title>DTI Algorithmic — Преимущества</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-md-10 offset-md-2 col-lg-9 offset-lg-3">
						<h1 class="caption">Преимущества</h1>
					</div>

					<div class="col-12 col-md-8 offset-md-2 col-lg-7 offset-lg-3">
						<p class="body_text">
							1. Ни одного убыточного года за 11 лет торговли (стратегия АВТОМАТ КАЛАШНИКОВА).
						</p>
						<p class="body_text">
							2. Квази Доверительное управление. Вы не переводите нам свои активы, а открываете застрахованный счет у крупнейшего американского брокера и подключаетесь к нашим стратегиям.
						</p>
						<p class="body_text">
							3. Торгуют системы, нет никакого «белкового трейдинга».
						</p>
						<p class="body_text">
							4. Ваши счета застрахованы.
						</p>
						<p class="body_text">
							5. Мы управляем клиентскими средствами теми же алгоритмами и с использованием того же программного обеспечения, что и собственным капиталом.
						</p>
					</div>
				</div>
			</div>
